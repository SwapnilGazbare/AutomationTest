...
namespace HelperLibrary
{
    ...
    { 
        ...
        {
            var javascript = Utils.driver as IJavaScriptExecutor;
            if (javascript == null)
        ...
        public static void ElementToBeClickable(this WebDriverWait wait, By locator)
        {
            wait.Until(element =>
            {
                var ele = Utils.driver.FindElement(locator);
                try
                {
        ...
        public static IWebElement ElementIsVisible(this WebDriverWait wait, By loc)
        {
            wait.Until(element =>
            {
                try
                {
                    var ele = Utils.driver.FindElement(loc);
        ...
        public static void FrameToBeAvailableAndSwitchToIt(this WebDriverWait wait, string frameName)
        {
            wait.Until(element =>
            {
                try
                {
                    return Utils.driver.SwitchTo().Frame(frameName);
                }
                catch
                {
                    return null;
        ...
        public static void FrameToBeAvailableAndSwitchToIt(this WebDriverWait wait, IWebElement loc)
        {
            wait.Until(element =>
            {
                try
                {
                    return Utils.driver.SwitchTo().Frame(loc);
                }
                catch
                {
                    return null;
        ...
        public static void AlertIsPresent(this WebDriverWait wait)
        {
            wait.Until(element =>
            {
                try
                {
                    return Utils.driver.SwitchTo().Alert();
                }
